...
## WT WT-TM456 WE WE-TM456

```{r}
# Read data 
hbond_stride100_trajectory=read.csv("/deac/salsburyGrp/wud18/md/TM_mutant/hbond/hbond_stride100_thrombin_TM456_WE_TM456_raw.csv")
```
...
```{r}
# Save csv
write.csv(df_unique, "/deac/salsburyGrp/wud18/md/TM_mutant/logistic_regression_Hbond/visualize/Hbond_stride100_unique.csv", row.names=F)
```
