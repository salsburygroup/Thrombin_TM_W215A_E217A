...
plt.plot(np.loadtxt('./TM_thrombin/rmsf_averaged_CA/rmsf_averaged_CA.dat')*10, label='WT', alpha=0.9, linewidth=1, color='r')
plt.plot(np.loadtxt('./TM456_Na0.125/rmsf_averaged_CA/rmsf_averaged_CA.dat')*10, label='TM456-WT', alpha=0.9, linewidth=1, color='g')
plt.plot(np.loadtxt('./thrombin_W215A_E217A/rmsf_averaged_CA/rmsf_averaged_CA.dat')*10, label='WE', alpha=0.9, linewidth=1, color='b')
plt.plot(np.loadtxt('./TM456_W215A_E217A/rmsf_averaged_CA/rmsf_averaged_CA.dat')*10, label='TM456-WE', alpha=0.9, linewidth=1, color='y')
