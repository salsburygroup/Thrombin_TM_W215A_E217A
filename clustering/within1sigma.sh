...
#for i in 170sLoop 180sLoop 220sLoop 60sLoop catalyticPocket catalyticTriad exositeI exositeII gammaLoop helix1 connection betaSheet1 30sLoop;do
for i in 180sLoop catalyticTriad;do
